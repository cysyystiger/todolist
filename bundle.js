...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _TodoApp = __webpack_require__(160);

	var _TodoApp2 = _interopRequireDefault(_TodoApp);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_reactDom2.default.render(_react2.default.createElement(_TodoApp2.default, null), document.querySelector('.container'));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _CountDisplay = __webpack_require__(163);
	  ...
	  function TodoApp(props) {
	    ...
	    _this.rendertodolist = function (arr) {
	      return _react2.default.createElement(
	        'ul',
	        { id: 'ful' },
	        arr.map(_this.rendertitle)
	      );
	    };

	    _this.rendertitle = function (fdtitle) {
	      if (fdtitle.title !== '') {
	        return _react2.default.createElement(
	          'li',
	          { key: fdtitle.title },
	          ...
	          _react2.default.createElement(
	            'ul',
	            null,
	            fdtitle.item.map(_this.renderitem)
	          )
	        );
	      }
	    };
	    ...
	    _this.renderitem = function (item) {
	      if (item !== '') {
	        return _react2.default.createElement(
	          'li',
	          { key: item },
	          _react2.default.createElement(_CountDisplay2.default, { checkboxes: function checkboxes() {
	              return _this.checkboxes();
	            } }),
	          item
	        );
	      }
	    ...
	    _this.renderuncount = function (num) {
	      var count = 0;
	      for (var i = 1; i < _this.state.list.length; i++) {
	        count = count + _this.state.list[i].item.length;
	      }
	      return count - num;
	    };

	    _this.rendercount = function (num) {
	      return num;
	    };

	    _this.state = { list: [{ title: '', item: [] }], count: 0 };
	    return _this;
	  }

	  _createClass(TodoApp, [{
	    key: 'buildTitle',
	    value: function buildTitle(value) {
	      this.setState({ list: [].concat(_toConsumableArray(this.state.list), [{ title: value, item: [] }]) });
	    }
	  }, {
	    key: 'deleteTitle',
	    value: function deleteTitle(value) {
	    ...
	    key: 'buildItem',
	    value: function buildItem(title, item) {
	      var a = this.state.list;
	      for (var i = 1; i < a.length; i++) {
	        if (a[i].title === title) {
	          a[i].item = [].concat(_toConsumableArray(a[i].item), [item]);
	        }
	      }
	      this.setState({ list: a });
	    }
	    ...
	    key: 'deleteItem',
	    value: function deleteItem(title, item) {
	      var a = this.state.list;
	      for (var i = 1; i < a.length; i++) {
	        if (a[i].title === title) {
	          for (var j = 0; j < a[i].item.length; j++) {
	            if (a[i].item[j] === item) {
	              a[i].item.splice(j, 1);
	            }
	          }
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'span',
	            { id: 'u' },
	            this.renderuncount(this.state.count),
	            ' '
	          )
	        ),
	        _react2.default.createElement(_TodoList2.default, {
	          buildTitle: function buildTitle(value) {
	            return _this2.buildTitle(value);
	          },
	          deleteTitle: function deleteTitle(value) {
	            return _this2.deleteTitle(value);
	          },
	          fixTitle: function fixTitle(ot, nt) {
	            return _this2.fixTitle(ot, nt);
	          }
	        }),
	        _react2.default.createElement(_TodoItem2.default, {
	          buildItem: function buildItem(title, item) {
	            return _this2.buildItem(title, item);
	          },
	          deleteItem: function deleteItem(title, item) {
	            return _this2.deleteItem(title, item);
	          }
	        }),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TodoList = function (_Component) {
	  ...
	  function TodoList(props) {
	    ...
	    _this.state = { bd: '', ot: '', rt: '' };
	    _this.onTitleBuild = _this.onTitleBuild.bind(_this);
	    _this.onTitleChange = _this.onTitleChange.bind(_this);
	    _this.onTitleDelete = _this.onTitleDelete.bind(_this);
	    _this.onTitleFix = _this.onTitleFix.bind(_this);
	    _this.onTitleot = _this.onTitleot.bind(_this);
	    _this.onTitlent = _this.onTitlent.bind(_this);
	    return _this;
	  }

	  _createClass(TodoList, [{
	    key: 'onTitleChange',
	    value: function onTitleChange(bd) {
	      this.setState({ bd: bd });
	    }
	  }, {
	    key: 'onTitleBuild',
	    value: function onTitleBuild(event) {
	      event.preventDefault();
	    ...
	    key: 'onTitleDelete',
	    value: function onTitleDelete(event) {
	      event.preventDefault();
	    ...
	    key: 'onTitleot',
	    value: function onTitleot(ot) {
	      this.setState({ ot: ot });
	    }
	  }, {
	    key: 'onTitlent',
	    value: function onTitlent(nt) {
	      this.setState({ nt: nt });
	    }
	  }, {
	    key: 'onTitleFix',
	    value: function onTitleFix(event) {
	      event.preventDefault();
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'form',
	          { onSubmit: this.onTitleBuild },
	          _react2.default.createElement(
	            'button',
	            { type: 'submit', className: 'btn btn-secondary', id: 'bl' },
	            'Build List'
	          )
	        ),
	        _react2.default.createElement(
	          'form',
	          { onSubmit: this.onTitleDelete },
	          _react2.default.createElement(
	            'button',
	            { type: 'submit', className: 'btn btn-secondary', id: 'dl' },
	            'Delete List'
	          )
	        ),
	        ...
	        _react2.default.createElement(
	          'form',
	          { onSubmit: this.onTitleFix, className: 'input-group-button' },
	          _react2.default.createElement(
	            'button',
	            { type: 'submit', className: 'btn btn-secondary', id: 'rp' },
	            'Replace'
	          ),
	          _react2.default.createElement('input', {
	            id: 'ot',
	            ...
	            value: this.state.ot,
	            onChange: function onChange(event) {
	              return _this2.onTitleot(event.target.value);
	            }
	          }),
	          _react2.default.createElement(
	            'span',
	          ...
	          _react2.default.createElement('input', {
	            ...
	            value: this.state.nt,
	            onChange: function onChange(event) {
	              return _this2.onTitlent(event.target.value);
	            }
	          })
	        )
	      );
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TodoItem = function (_Component) {
	  ...
	  function TodoItem(props) {
	    ...
	    _this.state = { title: '', item: '' };
	    _this.onItemBuild = _this.onItemBuild.bind(_this);
	    _this.onItemDelete = _this.onItemDelete.bind(_this);
	    _this.onItemChangeTitle = _this.onItemChangeTitle.bind(_this);
	    _this.onItemChangeItem = _this.onItemChangeItem.bind(_this);
	    return _this;
	  }

	  _createClass(TodoItem, [{
	    key: 'onItemChangeTitle',
	    value: function onItemChangeTitle(title) {
	      this.setState({ title: title });
	    }
	  }, {
	    key: 'onItemChangeItem',
	    value: function onItemChangeItem(item) {
	      this.setState({ item: item });
	    }
	  }, {
	    key: 'onItemBuild',
	    value: function onItemBuild(event) {
	      event.preventDefault();
	    ...
	    key: 'onItemDelete',
	    value: function onItemDelete(event) {
	      event.preventDefault();
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'form',
	          { onSubmit: this.onItemBuild, className: 'input-group-button' },
	          _react2.default.createElement(
	            'button',
	            { type: 'submit', className: 'btn btn-secondary', id: 'ai' },
	            'Add Item'
	          )
	        ),
	        _react2.default.createElement(
	          'form',
	          { onSubmit: this.onItemDelete, className: 'input-group-button' },
	          _react2.default.createElement(
	            'button',
	            { type: 'submit', className: 'btn btn-secondary', id: 'di' },
	            'Delete Item'
	          )
	        ),
	        _react2.default.createElement('input', {
	          ...
	          onChange: function onChange(event) {
	            return _this2.onItemChangeItem(event.target.value);
	          }
	        }),
	        _react2.default.createElement(
	          'span',
	        ...
	        _react2.default.createElement('input', {
	          ...
	          onChange: function onChange(event) {
	            return _this2.onItemChangeTitle(event.target.value);
	          }
	        })
	      );
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var CountDisplay = function (_Component) {
	  ...
	  _createClass(CountDisplay, [{
	    ...
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement('input', { type: 'checkbox', onClick: this.check });
	    }
	  }]);
